...
fn main() {
    ...
    let syntax_score = count_dots_in_folded_paper(transparent_paper_input);

    println!("The result is: {}", syntax_score);
}

fn count_dots_in_folded_paper(transparent_paper_input: Vec<String>) -> i32 {
...
mod tests {
    ...
    fn should_count_dots_for_small_input() {
        ...
        assert_eq!(count_dots_in_folded_paper(transparent_paper_input), 17);
    }
    ...
    fn should_count_dots_for_large_input() {
        ...
        assert_eq!(count_dots_in_folded_paper(transparent_paper_input), 678);
    }
}
