...
fn calculate_position(movements: Vec<String>) -> i32 {
    ...
    for movement in movements {
        ...
        match movement_direction {
            "forward" => {
                horizontal_position += movement_distance;
                depth += movement_distance * aim;
            }
            "up" => {
                aim -= movement_distance;
            }
            "down" => {
                aim += movement_distance;
            }
...
mod tests {
    ...
    fn should_calculate_position_with_small_input() {
        ...
        assert_eq!(calculate_position(movements), 900);
    }
    ...
    fn should_calculate_position_with_large_input() {
        ...
        assert_eq!(calculate_position(movements), 1997106066);
    }
}
